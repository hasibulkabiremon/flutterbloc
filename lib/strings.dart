...
const emailOrPasswordEmptyDescription =
    'You seem to have forgotten to enter the email or the password field, or both. Please Enter correctly';

const loginErrorDialogTitle = 'Login error';

const loginErrorDialogContent =
    'Invalid email/password combination. Please try again with valid login credential!';
